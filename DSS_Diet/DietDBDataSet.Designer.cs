...
namespace DSS_Diet {
    ...
    public partial class DietDBDataSet : global::System.Data.DataSet {
        ...
        public partial class ЭЛЕМЕНТ_РАЦИОНАDataTable : global::System.Data.TypedTableBase<ЭЛЕМЕНТ_РАЦИОНАRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public ЭЛЕМЕНТ_РАЦИОНАRow AddЭЛЕМЕНТ_РАЦИОНАRow(РАЦИОНRow parentРАЦИОНRowByРАЦИОН_Состоит_из_ЭЛЕМЕНТ_РАЦИОНА, ПРОДУКТRow parentПРОДУКТRowByПРОДУКТ_Является_частью_ЭЛЕМЕНТ_РАЦИОНА, int Количество_продукта) {
                ...
                if ((parentРАЦИОНRowByРАЦИОН_Состоит_из_ЭЛЕМЕНТ_РАЦИОНА != null)) {
                    columnValuesArray[1] = parentРАЦИОНRowByРАЦИОН_Состоит_из_ЭЛЕМЕНТ_РАЦИОНА[0];
                }
                if ((parentПРОДУКТRowByПРОДУКТ_Является_частью_ЭЛЕМЕНТ_РАЦИОНА != null)) {
                    columnValuesArray[2] = parentПРОДУКТRowByПРОДУКТ_Является_частью_ЭЛЕМЕНТ_РАЦИОНА[0];
                }
...
namespace DSS_Diet.DietDBDataSetTableAdapters {
    ...
    public partial class ЭЛЕМЕНТ_РАЦИОНАTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[ЭЛЕМЕНТ_РАЦИОНА] WHERE (([ID_элемента_рациона] = @Original_ID_" +
                "элемента_рациона) AND ([ID_рациона] = @Original_ID_рациона) AND ([ID_продукта] =" +
                " @Original_ID_продукта) AND ([Количество_продукта] = @Original_Количество_продук" +
                "та))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[ЭЛЕМЕНТ_РАЦИОНА] ([ID_рациона], [ID_продукта], [Количество_продукта]) VALUES (@ID_рациона, @ID_продукта, @Количество_продукта);
SELECT ID_элемента_рациона, ID_рациона, ID_продукта, Количество_продукта FROM ЭЛЕМЕНТ_РАЦИОНА WHERE (ID_рациона = @ID_рациона) AND (ID_элемента_рациона = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[ЭЛЕМЕНТ_РАЦИОНА] SET [ID_рациона] = @ID_рациона, [ID_продукта] = @ID_продукта, [Количество_продукта] = @Количество_продукта WHERE (([ID_элемента_рациона] = @Original_ID_элемента_рациона) AND ([ID_рациона] = @Original_ID_рациона) AND ([ID_продукта] = @Original_ID_продукта) AND ([Количество_продукта] = @Original_Количество_продукта));
SELECT ID_элемента_рациона, ID_рациона, ID_продукта, Количество_продукта FROM ЭЛЕМЕНТ_РАЦИОНА WHERE (ID_рациона = @ID_рациона) AND (ID_элемента_рациона = @ID_элемента_рациона)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID_элемента_рациона, ID_рациона, ID_продукта, Количество_продукта FROM dbo" +
                ".ЭЛЕМЕНТ_РАЦИОНА";
        ...
        public virtual int Delete(int Original_ID_элемента_рациона, int Original_ID_рациона, int Original_ID_продукта, int Original_Количество_продукта) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ID_элемента_рациона));
            this.Adapter.DeleteCommand.Parameters[1].Value = ((int)(Original_ID_рациона));
            this.Adapter.DeleteCommand.Parameters[2].Value = ((int)(Original_ID_продукта));
            this.Adapter.DeleteCommand.Parameters[3].Value = ((int)(Original_Количество_продукта));
        ...
        public virtual int Insert(int ID_рациона, int ID_продукта, int Количество_продукта) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(ID_рациона));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(ID_продукта));
            this.Adapter.InsertCommand.Parameters[2].Value = ((int)(Количество_продукта));
        ...
        public virtual int Update(int ID_рациона, int ID_продукта, int Количество_продукта, int Original_ID_элемента_рациона, int Original_ID_рациона, int Original_ID_продукта, int Original_Количество_продукта, int ID_элемента_рациона) {
            this.Adapter.UpdateCommand.Parameters[0].Value = ((int)(ID_рациона));
            this.Adapter.UpdateCommand.Parameters[1].Value = ((int)(ID_продукта));
            this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(Количество_продукта));
            this.Adapter.UpdateCommand.Parameters[3].Value = ((int)(Original_ID_элемента_рациона));
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_ID_рациона));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_ID_продукта));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((int)(Original_Количество_продукта));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int ID_продукта, int Количество_продукта, int Original_ID_элемента_рациона, int Original_ID_рациона, int Original_ID_продукта, int Original_Количество_продукта) {
            return this.Update(Original_ID_рациона, ID_продукта, Количество_продукта, Original_ID_элемента_рациона, Original_ID_рациона, Original_ID_продукта, Original_Количество_продукта, Original_ID_элемента_рациона);
        }
    }
